...
type Querier interface {
	...
	GetAlbumWithStats(ctx context.Context, id pgtype.UUID) (GetAlbumWithStatsRow, error)
	...
	GetStarredAt(ctx context.Context, arg GetStarredAtParams) (pgtype.Timestamptz, error)
	...
	ListAlbumsAlphabetical(ctx context.Context, arg ListAlbumsAlphabeticalParams) ([]ListAlbumsAlphabeticalRow, error)
	...
	ListStarredItemIDsByType(ctx context.Context, arg ListStarredItemIDsByTypeParams) ([]ListStarredItemIDsByTypeRow, error)
